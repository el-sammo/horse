			...
			if(customer.wagerAggression === 'high') {
				if(credits >= 300) {
					if(wagerTypes.indexOf('Win') > -1 && !wagerFound) {
						...
						wager.legs = 1;
						wager.parts = 1;
						wager.wagerSelections = randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7);
			...
			if(customer.wagerAggression === 'medium') {
				if(credits >= 300) {
					if(wagerTypes.indexOf('Win') > -1 && !wagerFound) {
						...
						wager.legs = 1;
						wager.parts = 1;
						wager.wagerSelections = randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7);
			...
			if(customer.wagerAggression === 'low') {
				if(credits >= 300) {
					if(wagerTypes.indexOf('Win') > -1 && !wagerFound) {
						...
						wager.legs = 1;
						wager.parts = 1;
						wager.wagerSelections = randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7) + ',' + randomIntFromInterval(1,7);
...
function getWagerRunners(runnerMix) {
	...
	newRMPcs.forEach(function(runnerCount) {
		var sectionRunners = [];
		while(runnerCount > 0) {
			var runnerNum = randomIntFromInterval(1,7);
