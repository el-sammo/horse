...
//	ssl: {
//	  ca: require('fs').readFileSync('/var/www/tix/ssl/ssl-ca.crt'),
//	  key: require('fs').readFileSync('/var/www/tix/ssl/ssl.key'),
//	  cert: require('fs').readFileSync('/var/www/tix/ssl/ssl.crt')
//	},
	...
	***************************************************************************/
	...
	/***************************************************************************
	* Authorize.net credential information
	***************************************************************************/

	authorizeNet: {
//	  api: '94gLB7P3zm',
//	  key: '527R2rV7bud7XbZK',
//	  sandbox: false
	  api: '',
	  key: '',
	  sandbox: true
