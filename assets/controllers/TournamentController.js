...
function controller(
	...
	function initMaps() {
		...
		poolMap[2]    = [1];
		poolMap[10]   = [.700, .300];
		poolMap[30]   = [.500, .300, .200];
		poolMap[40]   = [.400, .250, .200, .150];
		poolMap[50]   = [.370, .250, .150, .120, .110];
		poolMap[60]   = [.350, .220, .150, .110, .090, .080];
		poolMap[75]   = [.310, .210, .130, .100, .086, .065, .055, .045];
		poolMap[100]  = [.300, .200, .120, .095, .080, .060, .050, .040, .030, .025];
		poolMap[150]  = [.280, .170, .106, .086, .076, .053, .043, .033, .027, .021, .021];
		poolMap[200]  = [.270, .160, .100, .080, .070, .049, .039, .029, .024, .019, .019, .013];
		poolMap[250]  = [];
		poolMap[300]  = [];
		poolMap[350]  = [];
		poolMap[400]  = [];
